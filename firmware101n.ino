...
// ====== USER SETTINGS ======
#define FW_VERSION "1.0.1"  // bump this when you publish a new release
const char* SSID = "Arpinet-79732";
const char* PASS = "CIPR$2025";

// RAW link to latest.json in your repo:
const char* MANIFEST_URL = "https://github.com/annaalmasyan2-glitch/esp32-ota-demo/blob/main/latest.json";
